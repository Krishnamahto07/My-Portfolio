...
function Footer(){
    return (
        <div className="footer w-full h-full   flex justify-center flex-col items-center gap-5 ">
            ...
            <p className="md:text-sm text-xs font-semibold ">I design and code beautifully simple things, and I love what I do.</p>
            ...
            {/* for copyright text */}
            <div className="mb-5 underline font-semibold">@ Krishna mahto | all Rights Reserved </div>
        </div>
    )
}
